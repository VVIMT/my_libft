...
#    Updated: 2017/09/19 19:40:11 by vinvimo          ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
ft_strsub.c ft_strjoin.c ft_strjoin_char.c ft_strtrim.c ft_strsplit.c \
ft_itoa.c ft_putchar.c ft_putchar_w.c ft_putstr.c ft_putstr_w.c ft_putendl.c \
ft_putnbr.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c \
ft_lstadd.c ft_lstdel.c ft_lstdelone.c ft_lstiter.c ft_lstmap.c ft_lstnew.c \
ft_power.c ft_sqrt.c ft_swap.c
